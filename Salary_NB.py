...
Train = pd.read_csv("C:/Data Science/Assignments/Module-Naive Bayes/SalaryData_Train.csv")
Test = pd.read_csv("C:/Data Science/Assignments/Module-Naive Bayes/SalaryData_Test.csv")
